        ...
        echo "<table class='table-list'>";
            ...
            while($rowBanner=mysqli_fetch_array($queryBanner))
            {
                echo "<tr>
                        ...
                        <td><a target='blank' href='".BASE_URL."$rowBanner[link]'>Lihat postingan</a></td>
                        <td class='tengah'>$rowBanner[status]</td>
                        <td class='tengah'><a class='edit' href='".BASE_URL."index.php?page=my_profile&module=banner&action=form&banner_id=$rowBanner[banner_id]"."'>Edit</a></td>
                     </tr>";
